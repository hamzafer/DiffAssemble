...
PUZZLE_SIZES = [6]  # Only size 6
NUM_EXAMPLES_PER_SIZE = 1
MAX_ATTEMPTS = 100
CHECKPOINT_PATH = "/cluster/home/akmarala/DiffAssemble/Puzzle-Diff/jk8jhzia/checkpoints/last.ckpt"  # Updated checkpoint path

# Create output directory with meaningful name
output_dir = Path("results_jpwleg3_6x6")
...
if all_successes:
    ...
    success_path = output_dir / "success_jpwleg3_6x6.png"
...
if all_failures:
    ...
    failure_path = output_dir / "failure_jpwleg3_6x6.png"
...
print(f"   📊 {success_path.name} - 1 success for 6x6 jpwleg3")
print(f"   ❌ {failure_path.name} - 1 failure for 6x6 jpwleg3")
